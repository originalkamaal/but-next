...
const Sidebar = () => {
  ...
  const [openMenu, setDropdown] = useState([])
    ...
    return (
        <>
            {<div className='mr-2 flex justify-center w-72 h-full bg-gray-900'>
                <div className="flex flex-col w-full h-full min-h-screen overflow-x-hidden overflow-y-visible bg-gray-900">
                    <div className="px-6 pt-8">
                        <div className="flex items-center justify-between">

                            <Link
                                href="/admin"
                                className="p-1.5 rounded w-full flex items-center justify-center focus:outline-none focus:ring-1  focus:ring-offset-2 "
                            >
                                <Logo color='#ffffff' className='' />
                            </Link>
                        ...
                        <ul className="flex flex-col space-y-2">
                            {menu.map((m, i) => (
                                <li key={i} className={`relative ${router.pathname == m.link ? 'text-white' : 'text-gray-500 hover:text-white'}  focus-within:text-white`}>
                                    ...
                                    >
                                        <div className="flex items-center w-full" onClick={() => {
                                            ...
                                            {m.link ?
                                                ...
                                                :
                                                <span
                                                    className="cursor-pointer inline-block w-full py-2 pl-8 pr-4 text-xs rounded hover:bg-gray-800 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-gray-800"
                                                >{m.title}</span>
                                            }
                                        </div>
                                        {m.children &&
                                    ...
                                    {m.children && openMenu.includes(m.title) &&
                    ...
                    <div className="px-6 pt-4 mb-auto first-letter:pb-8">
                        <ul>
